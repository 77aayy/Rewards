  ...
  function doReveal() {
    ...
    requestAnimationFrame(function () {
      requestAnimationFrame(function () {
        ...
        }, 100); // Reduced delay for snappier reveal
      });
    });
  }

  // Execute immediately, don't wait for window.onload which can be blocked by failed network requests (like 404 images)
  doReveal();
}
